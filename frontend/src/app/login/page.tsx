    ...
    <div className="flex flex-col md:flex-row h-screen w-full bg-black overflow-hidden font-sans">
       ...
       <div className="w-full md:w-1/2 bg-[#0b1120] border-b md:border-b-0 md:border-r border-slate-800 flex flex-col justify-center items-center p-12 relative group">
           ...
           <div className="relative z-10 flex flex-col items-center">
             ...
             <a href="http://localhost:8000/api/auth/login/azure" className="flex items-center space-x-3 bg-slate-100 hover:bg-white text-black font-semibold px-6 py-3.5 rounded-lg transition-transform hover:-translate-y-1 w-full max-w-sm justify-center shadow-lg hover:shadow-[0_10px_30px_rgba(255,255,255,0.1)]">
       ...
       <div className="w-full md:w-1/2 bg-zinc-950 flex flex-col justify-center items-center p-12 relative group">
           ...
           <div className="relative z-10 flex flex-col items-center">
             ...
             <a href="http://localhost:8000/api/auth/login/discord" className="flex items-center space-x-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold px-6 py-3.5 rounded-lg transition-transform hover:-translate-y-1 w-full max-w-sm justify-center shadow-[0_10px_30px_rgba(88,101,242,0.3)] border border-[#5865F2]/50">
