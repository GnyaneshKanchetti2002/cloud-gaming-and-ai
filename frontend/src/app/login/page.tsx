...
function LoginTerminal() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-full bg-black overflow-hidden font-sans relative">
        
        {/* Error Message Toast */}
        {error && (
          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 bg-rose-500 text-white px-6 py-3 rounded-full font-bold shadow-lg animate-bounce">
            {error === 'auth_failed' ? 'Authentication Failed. Please try again.' : 
             error === 'missing_token' ? 'Secure session expired. Please log in.' : 
